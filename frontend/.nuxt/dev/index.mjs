...
const bankRecommendations = defineEventHandler(async (event) => {
  try {
    ...
    const branchImportance = requestData["Number of Branches"] > 2e3 ? 0.8 : 0.4;
...
const bankRecommendations$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: bankRecommendations
});

const companyNews = defineEventHandler(async (event) => {
  const query = getQuery$1(event);
...
const companyNews$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: companyNews
});

const FINNHUB_BASE_URL = "https://finnhub.io/api/v1";
const FINNHUB_API_KEY = "cvsttqhr01qhup0t27agcvsttqhr01qhup0t27b0";
const FINNHUB_ENDPOINTS = {
  QUOTE: (symbol) => `${FINNHUB_BASE_URL}/quote?symbol=${symbol}&token=${FINNHUB_API_KEY}`,
  COMPANY_PROFILE: (symbol) => `${FINNHUB_BASE_URL}/stock/profile2?symbol=${symbol}&token=${FINNHUB_API_KEY}`,
  SYMBOL_SEARCH: (query) => `${FINNHUB_BASE_URL}/search?q=${query}&token=${FINNHUB_API_KEY}`,
  COMPANY_NEWS: (symbol, from, to) => `${FINNHUB_BASE_URL}/company-news?symbol=${symbol}&from=${from}&to=${to}&token=${FINNHUB_API_KEY}`,
  MARKET_NEWS: () => `${FINNHUB_BASE_URL}/news?category=general&token=${FINNHUB_API_KEY}`,
  FINANCIALS: (symbol) => `${FINNHUB_BASE_URL}/stock/metric?symbol=${symbol}&metric=all&token=${FINNHUB_API_KEY}`,
  EARNINGS: (symbol) => `${FINNHUB_BASE_URL}/stock/earnings?symbol=${symbol}&token=${FINNHUB_API_KEY}`,
  // Additional endpoints for features previously using Alpha Vantage
  COMPANY_OVERVIEW: (symbol) => `${FINNHUB_BASE_URL}/stock/profile2?symbol=${symbol}&token=${FINNHUB_API_KEY}`,
  BASIC_FINANCIALS: (symbol) => `${FINNHUB_BASE_URL}/stock/metric?symbol=${symbol}&metric=all&token=${FINNHUB_API_KEY}`
};

const companyProfile = defineEventHandler(async (event) => {
  try {
...
const companyProfile$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: companyProfile
});

const companySearch = defineEventHandler(async (event) => {
  try {
    const API_KEY = FINNHUB_API_KEY;
    if (!API_KEY) ;
    const query = getQuery$1(event);
    ...
    if (data.result && Array.isArray(data.result)) {
      const formattedResults = data.result.slice(0, Number(limit)).map((item) => ({
        symbol: item.symbol,
...
const companySearch$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: companySearch
});

const financialMetrics = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const metrics = (financialsData == null ? void 0 : financialsData.metric) || {};
    ...
    const result = {
      metrics: {
        [0]: {
          ...
          date: currentDate,
          peRatio: ((_a = metrics.peBasicExclExtraTTM) == null ? void 0 : _a.toString()) || null,
          pegRatio: ((_b = metrics.pegNormalizedAnnual) == null ? void 0 : _b.toString()) || null,
          dividendYield: ((_c = metrics.dividendYieldIndicatedAnnual) == null ? void 0 : _c.toString()) || null,
          dividendPerShare: ((_d = metrics.dividendPerShareAnnual) == null ? void 0 : _d.toString()) || null,
          marketCap: ((_e = profileData.marketCapitalization) == null ? void 0 : _e.toString()) || null,
          enterpriseValue: ((_f = metrics.enterpriseValueOverEBITDA) == null ? void 0 : _f.toString()) || null,
          evToSales: ((_g = metrics.evToSalesTTM) == null ? void 0 : _g.toString()) || null,
          evToEbitda: ((_h = metrics.evToEBITDATTM) == null ? void 0 : _h.toString()) || null,
          bookValuePerShare: ((_i = metrics.bookValuePerShareQuarterly) == null ? void 0 : _i.toString()) || null,
          priceToBookRatio: ((_j = metrics.pbQuarterly) == null ? void 0 : _j.toString()) || null
        }
      },
      ratios: {
        [0]: {
          symbol: profileData.ticker,
          date: currentDate,
          returnOnEquity: ((_k = metrics.roeTTM) == null ? void 0 : _k.toString()) || null,
          returnOnAssets: ((_l = metrics.roaTTM) == null ? void 0 : _l.toString()) || null,
          profitMargin: ((_m = metrics.netProfitMarginTTM) == null ? void 0 : _m.toString()) || null,
          operatingMargin: ((_n = metrics.operatingMarginTTM) == null ? void 0 : _n.toString()) || null,
          revenuePerShare: ((_o = metrics.revenuePerShareTTM) == null ? void 0 : _o.toString()) || null,
          debtToEquity: ((_p = metrics.totalDebtOverTotalEquityQuarterly) == null ? void 0 : _p.toString()) || null,
          currentRatio: ((_q = metrics.currentRatioQuarterly) == null ? void 0 : _q.toString()) || null,
          priceToSalesRatio: ((_r = metrics.psTTM) == null ? void 0 : _r.toString()) || null
        }
      },
      growth: {
        [0]: {
          symbol: profileData.ticker,
          date: currentDate,
          revenueGrowth: ((_s = metrics.revenueGrowthQuarterlyYoy) == null ? void 0 : _s.toString()) || null,
          earningsGrowth: ((_t = metrics.epsGrowthQuarterlyYoy) == null ? void 0 : _t.toString()) || null,
          dividendGrowth: ((_u = metrics.dividendGrowthRate5Y) == null ? void 0 : _u.toString()) || null,
          epsgrowth: ((_v = metrics.epsGrowth3Y) == null ? void 0 : _v.toString()) || null
        }
      }
    };
    return result;
...
const financialMetrics$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: financialMetrics
});

const finnhubNews = defineEventHandler(async (event) => {
  try {
    const query = getQuery$1(event);
...
const finnhubNews$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: finnhubNews
});
...
const stockNews = defineEventHandler(async (event) => {
  try {
    const API_KEY = FINNHUB_API_KEY;
    const query = getQuery$1(event);
    ...
    const limitedData = Number(limit) > 0 ? data.slice(0, Number(limit)) : data;
    return {
      feed: limitedData
    };
  } catch (error) {
...
const stockNews$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: stockNews
});
